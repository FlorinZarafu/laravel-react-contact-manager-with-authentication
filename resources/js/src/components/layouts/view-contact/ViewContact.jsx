...
class ViewContact extends Component {
    ...
    onChange = currentPage => {
        if (this.state.search_content == "") {
            ...
            this.props.loadSearchContactUser(
        ...
        return (
            <div>
                ...
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        {loadContacts && loadContacts.hasOwnProperty("data")
                            ? loadContacts.data.data.map(row => (
                                  <TableRow key={row.id}>
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        loadSearchContactUser: (search_content, page) =>
            dispatch(loadSearchContactUser(search_content, page)),
